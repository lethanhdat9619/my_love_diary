...
function timeElapse(date, mode){
	...
	var result = "";
	if (mode == 1) {
		result = (years > 0 ? "<span class=\"digit\">" + years + "</span> năm ":"")
			+ (months >= 0 ? "<span class=\"digit\">" + months + "</span> tháng ":"")
		...
		result = "<span class=\"digit\">" + days + "</span> ngày <span class=\"digit\">" + hours + "</span> giờ <span class=\"digit\">" + minutes + "</span> phút <span class=\"digit\">" + seconds + "</span> giây";
	}
...
function adjustWordsPosition() {
	...
	$('#words').css("top", $("#garden").position().top + 25);
